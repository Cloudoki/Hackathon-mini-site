...
/**
 * Add extra option fields in General Settings page
 */
require get_template_directory() . '/inc/settings-fields.php';
...
/** Check if CPT has any posts */
function check_has_posts( $post ){
	$check = new WP_Query( array('post_type'=>$post, 'posts_per_page'=>-1) );
	if( $check->have_posts() ){
		return true;
	}
	return false;
